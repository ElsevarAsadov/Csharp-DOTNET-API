...
namespace Api.Business.Services.Implementations
{
    public class WorkerService : IWorkerService
    {
        ...
        public async Task<IEnumerable<WorkerGetDto>> GetAllAsync(string? input, int? professionId, int? orderId)
        {
            ...
            IEnumerable<WorkerGetDto> workerGetDtos = workers.Select(worker => new WorkerGetDto { Id = worker.Id, FullName = worker.FullName, Description = worker.Description, MediaUrl = worker.SocialMediaUrl, Salary = worker.Salary });
